...
int MapMinFeedback = 180;
int MapMaxFeedback = 1023;
...
int AdjustedAnalogRead(int pin) {
  int value = analogRead(pin);
  return map(value, MapMinFeedback, MapMaxFeedback, 0, 1023);
}
...
//   Serial.write(OCR1AH);
    ...
    while (1==1) 
    {
        ...
        if (PIDProcessCounter >= PIDProcessDivider)
        {
            ...
            Feedback1 = AdjustedAnalogRead(FeedbackPin1);
            ...
            Feedback2 = AdjustedAnalogRead(FeedbackPin2);
            ...
            Feedback3 = AdjustedAnalogRead(FeedbackPin3);
